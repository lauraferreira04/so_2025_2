...
//   uma thread; se precisar aumentar demais, troque os dados de int para long
#define N 2000000000
// número de threads -- altere para mudar o nível de paralelismo
#define NT 4
// espaço entre os dados manipulados por threads diferentes - altere para ver
